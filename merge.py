...
folder_path = '/home/jamalids/Documents/2D/logUCR-C (1)'
...
file_path = '/home/jamalids/Documents/2D/1.csv'
...
filtered_df = merged_df[(merged_df['rate_base_vs_zstd'] > 1) & (merged_df['rate_base_vs_lz4'] >1 )&
...
print(f"Rows where 'rate_base_vs_all' < 0.5:,{count_rate}")
...
import pandas as pd
import numpy as np
dataset_path=dataset_path = '/home/jamalids/Documents/2D/UCRArchive_2018/DodgerLoopDay/DodgerLoopDay_TEST.tsv'
...
df=merged_df[(merged_df['Feature Index']==5) & (merged_df['Dataset Name'] == 'DodgerLoopDay_TEST')]
df.head(30)
...
file_path = '/home/jamalids/Documents/2D/DodgerLoopDay_TEST.csv'
