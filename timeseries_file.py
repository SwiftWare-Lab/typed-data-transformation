...
def pipeline(
        ...
        dataset_name: Optional[str] = None,  # Moved to the end
) -> pd.DataFrame:
    # Simple consistency check
    if train_size < 0 or train_size > 1:
        raise ValueError('Train size must be between 0 and 1')

    if dataset_path:  # Check if dataset_path is provided
...
if __name__ == '__main__':
    ...
    for dataset in dataset_paths:
        ...
        if dataset_path:
            ...
            print(f"No file path found for dataset: {dataset}")
