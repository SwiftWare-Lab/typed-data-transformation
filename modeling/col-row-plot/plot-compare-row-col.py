...
# ====================================
directories = [r"C:\Users\jamalids\Downloads\row-col-order\row-col-order\column\fastlz-col"]
dataframes = []
...
all_data_output_path = r"C:\Users\jamalids\Downloads\row-col-order\row-col-order\column\combined_all_data.csv"
...
median_output_path = r"C:\Users\jamalids\Downloads\row-col-order\row-col-order\column\combined_median_rows.csv"
...
#   (a) Select the "Decompose_Block_Parallel" row with the maximum CompressionRatio
...
selected_output_path = r"C:\Users\jamalids\Downloads\row-col-order\row-col-order\column\selected_pairs.csv"
...
#     (using the "Decompose_Block_Parallel" row).
...
final_output_path_A =r"C:\Users\jamalids\Downloads\row-col-order\row-col-order\column\max_compression_throughput_pairs.csv"
...
final_output_path_B = r"C:\Users\jamalids\Downloads\row-col-order\row-col-order\column\max_decompression_throughput_pairs.csv"
...
create_and_save_plot(final_df_A, "(Max CompressionThroughput Pair)",
                     r"C:\Users\jamalids\Downloads\row-col-order\row-col-order\column\plot_max_compression_throughput1.png")
create_and_save_plot(final_df_B, "(Max DecompressionThroughput Pair)",
                     r"C:\Users\jamalids\Downloads\row-col-order\row-col-order\column\plot_max_decompression_throughput1.png")
