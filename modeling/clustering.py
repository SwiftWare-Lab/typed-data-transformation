...
def run_analysis(folder_path):
    ...
    for tsv_file in tsv_files:
        ...
        folder_path1 = r"C:\Users\jamalids\Downloads"  # Update as needed
        ...
        #window_size =921600
       # window_size = 1024
        component_sizes = [1, 1, 1, 1,1,1,1,1]  # Assuming four groups, each of size 1 byte
...
if __name__ == "__main__":
    ...
    folder_path = r"C:\Users\jamalids\Downloads\dataset\Low-Entropy\Low-Entropy\64"  # Update as needed
