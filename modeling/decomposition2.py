...
#     dataset_path = "/home/jamalids/Documents/2D/data1/Fcbench/Fcbench-dataset/32/citytemp_f32.tsv"
#     m = 4               # For float32
#     chunk_size = -1     # If not -1, we do block-based
#     contig_order = False
#
...
#             zero_based_groups.append(tuple(g - 1 for g in group))  # e.g. [1,2] => (0,1)
#         converted_decomps.append(tuple(zero_based_groups))
#     # Now `converted_decomps` is a list of zero-based decompositions
#
#     # ---------------------------------------------------------------
#     # 2) Build your compression tool dictionary
#     # ---------------------------------------------------------------
#     comp_tool_dict = {
#
#       'zstd': zstd_comp,
