...
# 1) Read each CSV
df_entropy = pd.read_csv("/home/jamalids/Documents/combine all/all_entropy_summaries.csv")
df_comp = pd.read_csv("/home/jamalids/Documents/combine all/combined_entropy.csv")
df_inf = pd.read_csv("/home/jamalids/Documents/combine all/combined_zstd.csv")
...
final_merged_df.to_csv("/home/jamalids/Documents/merged.csv", index=False)

print("Merged CSV created:", "/home/jamalids/Documents/merged.csv")
