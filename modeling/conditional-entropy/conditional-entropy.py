...
def extract_delta(global_stream, byte_group, window_size=1048576):
    """
    ...
    for fname in tsv_files:
        ...
        for scenario_name, extractor in feature_scenarios.items():
            ...
            if scenario_name == "Delta":
                feature_list = [extractor(global_stream, grp,1048576)
...
if __name__ == "__main__":
    folder_path =  '/home/jamalids/Documents/2D/data1/Fcbench/Fcbench-dataset/32/HPC/test'
