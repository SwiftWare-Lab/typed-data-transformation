...
directories = ["/mnt/c/Users/jamalids/Downloads/figs/results/64"]
...
if dataframes:
    ...
    all_data_output_path = "/mnt/c/Users/jamalids/Downloads/figs/64.CSV"
...
df = pd.read_csv('/mnt/c/Users/jamalids/Downloads/figs/64.csv')
...
plt.tight_layout()
plt.savefig("/mnt/c/Users/jamalids/Downloads/best_decomp_ratio.png")
plt.close()
...
plt.xticks(rotation=90)
plt.tight_layout()
plt.savefig("/mnt/c/Users/jamalids/Downloads/gmean_decomp_ratio32.png")
plt.close()
...
plt.xticks(rotation=90)
plt.tight_layout()
plt.savefig("/mnt/c/Users/jamalids/Downloads/silhouette_best_decomp_ratio_by_feature32.png")
plt.close()
...
plt.xticks(rotation=90)
plt.tight_layout()
plt.savefig("/mnt/c/Users/jamalids/Downloads/std_decomp_ratio_by_feature32.png")
plt.close()
...
plt.xticks(rotation=90)
plt.tight_layout()
plt.savefig("/mnt/c/Users/jamalids/Downloads/std_best_silhouette_by_feature32.png")
plt.close()
