...
def run_and_collect_data():
    ...
    for in_size in sizes:
        ...
        compressed_bool_array = char_to_bool(compressed_char_array)
        pattern_comp, pattern_comp_dict_zstd, pattern_comp_dict_estimated, pattern_comp_dict_int_zstd = compute_comp_size(compressed_bool_array, inverse_cw_dict, dictionary_size, m, n)
        ...
        results.append({
            ...
            "pattern_comp_dict":pattern_comp_dict_estimated,
...
# Plot each pattern
plt.plot(df_results['Original Size (bytes)'], df_results['pattern_comp'], marker='o', label="pattern_comp")
plt.plot(df_results['Original Size (bytes)'], df_results['pattern_comp_dict_zstd'], marker='s', label="pattern_comp_dict_zstd")
plt.plot(df_results['Original Size (bytes)'], df_results['pattern_comp_dict'] ,marker='^', label="pattern_comp_dict")
plt.plot(df_results['Original Size (bytes)'], df_results['pattern_comp_dict_int_zstd'], marker='d', label="pattern_comp_dict_int_zstd")
