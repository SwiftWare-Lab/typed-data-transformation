...
###################################################################################
# Example 
ts_list, y_true, _, _ = UCR_UEA_datasets().load_dataset('Heartbeat')
feature_data1 = ts_list[:, :,1].reshape(-1)
...
m, n = 10,16
stats16, pattern_occurance,matched_binary_representations,pattern_list,lookup_table=compress_block_based(img_array, m, n)
stats=stats16
