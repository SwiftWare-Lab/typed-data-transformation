...
def generate_cpp_command(datasets, executable_name, output_csv_path, num_threads=1):
    ...
    for dataset in datasets:
        ...
        # Command line for your C++ executable
...
def generate_cpp_command(datasets, executable_name, output_csv_path, num_threads=1):
    ...
    for dataset in datasets:
        ...
        script_content += f"./{executable_name} --dataset={dataset} --output={os.path.join(output_csv_path, output_csv_name)} --threads={num_threads}\n\n"
    return script_content
...
if __name__ == "__main__":
    ...
    for i, dataset_group in enumerate(dataset_groups):
        ...
        sbatch_script_ucr_content += generate_cpp_command(dataset_group, script_name, csv_output_dir)
