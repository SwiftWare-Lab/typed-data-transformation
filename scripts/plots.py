...
def calculate_metrics(df):
    ...
    avg_com_ratio_b1 = df['com_ratio_b1'].mean()
    avg_t_com_ratio_b1 = df['t_com_ratio_b1'].mean()
    avg_com_ratio_b2 = df['com_ratio_b2'].mean()
    avg_t_com_ratio_b2 = df['t_com_ratio_b2'].mean()
    avg_com_ratio_b3 = df['com_ratio_b3'].mean()
    avg_t_com_ratio_b3 = df['t_com_ratio_b3'].mean()
    ...
    comp_ratio_zstd_default = df['comp_ratio_zstd_default'].mean()
    comp_ratio_l22 = df['comp_ratio_l22'].mean()
    Non_uniform_1x4 = df['Non_uniform_1x4'].mean()
    return {
...
#"/home/jamalids/Documents/compression-part3/Fcbench/Results_10000K"
...
plt.tight_layout()
plt.savefig('UCR.jpg', format='jpg', dpi=300)
plt.show()