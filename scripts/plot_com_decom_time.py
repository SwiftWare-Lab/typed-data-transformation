...
file_path = '/home/jamalids/Documents/2D/data1/Fcbench/logH/combined_data.csv'
...
sns.lineplot(ax=axes[0], x='dataset', y='CompressionRatio', hue='Type', marker='o', data=df)
...
sns.lineplot(ax=axes[1], x='dataset', y='TotalTimeCompressed', hue='Type', marker='o', data=df)
...
sns.lineplot(ax=axes[2], x='dataset', y='TotalTimeDecompressed', hue='Type', marker='o', data=df)
...
# Adjust layout
plt.tight_layout()
plt.savefig('/home/jamalids/Documents/2D/data1/Fcbench/logH/compression_ratios_comparison_by_method.png', bbox_inches='tight')
plt.show()
