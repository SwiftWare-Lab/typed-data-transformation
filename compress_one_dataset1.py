...
if __name__ == "__main__":
    ...
    results_df = pd.DataFrame({
        ...
        'Original Size': [result[3]['stats']['original_size'] if 'stats' in result[3] and 'original_size' in result[3]['stats'] else None for result in results],
        'Num Patterns': [result[3]['stats']['num_patterns'] if 'stats' in result[3] and 'num_patterns' in result[3]['stats'] else None for result in results],
        ...
        'Num Non-Zero Patterns': [result[3]['stats']['num_nz_patterns'] if 'stats' in result[3] and 'num_nz_patterns' in result[3]['stats'] else None for result in results],
        'Size Per Pattern': [result[3]['stats']['size_per_pattern'] if 'stats' in result[3] and 'size_per_pattern' in result[3]['stats'] else None for result in results],
